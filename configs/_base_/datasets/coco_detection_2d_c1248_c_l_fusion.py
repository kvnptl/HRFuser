...
train_pipeline = [
    ...
    dict(type='Crop', crop_size=(768, 1280), offsets=(202, 280), skip_keys=['lidar_img']),
    dict(type='Resize', img_scale=(1280, 768), keep_ratio=False, skip_keys=['lidar_img']),
    ...
    dict(type='RandomDrop', p = [0.5, 0.5, 0.5, 0.5], keys=['img', 'lidar_img']),
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            # dict(type='Normalize', **gated_norm_cfg, keys=['gated_img'], sensor_type='gated'),
            dict(type='Crop', crop_size=(768, 1280), offsets=(202, 280), skip_keys=['lidar_img']),
            dict(type='Resize', keep_ratio=False, skip_keys=['lidar_img']),
