_base_ = [
    '../_base_/models/cascade_rcnn_hrfuser_fpn_nus_cl_fusion_saf_fcos_no_drop.py',
    '../_base_/datasets/nuscenes_detection_r640_cl_fusion_saf_fcos_no_drop.py', '../_base_/default_runtime.py',
