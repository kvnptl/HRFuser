_base_ = [
    '../_base_/models/cascade_rcnn_hrfuser_fpn_nus_clr_fusion_saf_fcos_no_drop.py',
    '../_base_/datasets/nuscenes_detection_r640_clr_fusion_saf_fcos_no_drop.py', '../_base_/default_runtime.py',
