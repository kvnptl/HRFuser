_base_ = [
    '../_base_/models/cascade_rcnn_hrfuser_fpn_nus_cr_fusion_saf_fcos.py',
    '../_base_/datasets/nuscenes_detection_r640_cr_fusion_saf_fcos_no_drop.py', '../_base_/default_runtime.py',
