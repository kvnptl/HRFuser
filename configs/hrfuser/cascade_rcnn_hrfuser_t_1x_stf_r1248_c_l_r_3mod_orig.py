_base_ = [
    '../_base_/models/cascade_rcnn_hrfuser_fpn_stf_c_l_r_fusion.py',
    '../_base_/datasets/kitti_detection_2d_c1248_c_l_r_fusion.py', '../_base_/default_runtime.py',
...
model = dict(
    backbone=dict(
        ...
        drop_path_rate=0.,
        mod_in_channels=[3, 2], # 3:Lidar, 2: Radar, 1: Gated
        extra=dict(
            ModFusionA=dict(
                num_channels=(18, 36)),
            LidarStageB=dict(
